...
public class Item {
	...
	public static final Weapon stick = new Weapon(Res.ITEMS_WORLD.texs[2][0], Res.ITEMS_WEAPONS.texs[0][2], Res.ITEMS_INV.texs[3][0],
			new Quad(-25, -2, 50, 50), new Quad(-55, -21, 80, 40), 180, "Stick", 3);
	public static final Weapon candyCane = new Weapon(Res.ITEMS_WORLD.texs[3][0], Res.ITEMS_WEAPONS.texs[0][3], Res.ITEMS_INV.texs[5][0],
